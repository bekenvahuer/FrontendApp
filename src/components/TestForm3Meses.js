...
const TestForm3Meses = () => {
    ...
    const [formData, setFormData] = useState({
        ...
        skills: "",
        comprobanteDePago: "",
        planDePago: "3meses", // Plan de pago fijo para esta vista
        IdAdmin: "",
        nombreNegocio: "",
        whatsapp: "",
        direccionNegocio: "",
    ...
    const paymentData = {
        amount: "39999", // Monto para 1 mes
        name: "3 Meses", // Nombre del plan
