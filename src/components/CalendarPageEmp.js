...
const CalendarPageEmp = () => {
        ...
        axios.get(`${API_BASE_URL}/events`)
            .then(response => {
                const filteredEvents = response.data.filter(event =>
                    event.title.includes(`/${username}`) && event.employee === `${username3}`
                );
    ...
    return (
        <div className='Container-calendar'>
            <SidebarEmp toggleQRView={toggleQRView} setCalendarView={setCalendarView} />
            <Carrucel />
                                ...
                                <div className="modal-buttons">
                                    {/* <button
                                        onClick={() => {
                                            ...
                                            setIsActionModalOpen(false);
                                            navigate('/events/createUser', { state: { start: selectedSlot.start, end: selectedSlot.end } });
                                        }}
                                        style={{ background: "#d091ab", color: "#090027", padding: "10px 20px", border: "none", borderRadius: "5px", marginRight: "10px", cursor: "pointer" }}
                                    >
                                        Agendar
                                    </button> */}
                                    <button
                            ...
                            <>
                                {selectedEvent ? (
                                    <>
                                        ...
                                        <p><strong>Empleado:</strong> {username3}</p>
...
export default CalendarPageEmp;